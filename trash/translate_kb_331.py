...
translated_keys = {
  "dtd.parser.message.left.paren.or.entityref.or.empty.or.any.expected": "( 또는 엔티티 참조 또는 EMPTY 또는 ANY가 필요합니다",
  "dtd.parser.message.literal.public.system.expected": "리터럴, PUBLIC 또는 SYSTEM이 필요합니다",
  "dtd.parser.message.name.expected": "XML 이름이 필요합니다",
  "dtd.parser.message.name.or.entity.ref.expected": "XML 이름 또는 엔티티 참조가 필요합니다",
  "dtd.parser.message.rparen.expected": ")가 필요합니다",
  "dtd.parser.message.whitespace.expected": "공백이 필요합니다",
  "dtd.parser.message.expected.prologue.tag.termination.expected": "'?>'가 필요합니다",
...
for item in data["new_files"]:
    if item["filename"] == "XmlParserBundle.properties":
...
if not file_found:
    data["new_files"].append({
        "filename": "XmlParserBundle.properties",
...
print("XmlParserBundle translated successfully.")